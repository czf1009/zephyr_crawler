...
class ProxyMiddleware(object):
    ...
    def __init__(self):
        ...
        self.proxys_min = 10
        # request.meta["dont_redirect"] = True  # sometimes proxy will redirect to a strange url
    ...
    def crawl_proxy_kxdaili(self):
        for i in range(1,11):
            root = self.get_url_xpath('http://www.kxdaili.com/ipList/%d.html#ip' % i)
    ...
    def test_proxy(self):
        ...
        for i in range(self.test_thread_num):
            ...
            t = threading.Thread(target=self.test_proxy_thread, args=(proxys_part))
            threads.append(t)
            t.start()
